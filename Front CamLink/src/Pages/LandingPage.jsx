...
function LandingPage() {
  ...
  return (
    ...
    <div className='bg-blur landingPage pb-11 '>
      ...
      <div className='content flex justify-evenly'>
        <div className='w-[30%]' >
            <h1  className='font-bold text-4xl p-2 animate-bounce text--900 text-gray-300' style={{ fontFamily: 'monoton' }}>CamLink</h1>
          ...
          <div className='w-[40%]'>
            ...
            <div className='flex justify-around'>
              ...
              <a href = "https://192.168.8.6:5500 "><div><button className=' duration-350 hover:scale-90 btn-1 third'>Join us</button></div> </a>
  ...
  <div data-aos='fade-left'>
    ...
    <img className='w-[20rem]' src="./Images/LandingPage.jpg" alt="" />
        ...
        <Typography variant='h2' sx={{ my: 4, textAlign: 'center', color: 'primary.main', fontFamily:'serif'}}>Services</Typography>
        <Box
          sx={{
            display: 'flex',
            pt: 4,
